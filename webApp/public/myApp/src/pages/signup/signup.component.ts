...
export class SignupComponent implements OnInit {
	...
	signUp(form){
		this.http.post('https://hussh.site/signup', JSON.stringify({"Username":form._value.username, "Password":form._value.password, "FirstName":form._value.fname, "LastName":form._value.lname, "Email":form._value.email}))
			.subscribe(
